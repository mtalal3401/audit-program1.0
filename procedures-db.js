...
// Load this file BEFORE app_new.js
//
// Structure expected by app_new.js:
// window.PROGRAM_DB = {
//   meta: {...},
  ...
  window.PROGRAM_DB = {
    ...
    areas: {
      ...
      LTD: {
        ...
        procedures: {
          "Analytical Procedures": [
           proc("", "Compare  current  year  balances  and expense  with  last  year  balances  and expenses and ensure that any significant variation should be properly and logically reasoned.", "LTD-AP-01")
          ],
          "Test of Controls": [
            proc("","Assess the reasonableness of design of system  of  internal  control  by  enquiring relevant client personnel and documenting the same (if not a documented system manual has been developed by the client). A walk through test would be necessary to confirm the understanding as documented. Identify the preventive (exercised before occurrence of transactions and event) and detective (exercised after occurrence of transaction and event) controls established by management to support its assertions.","LTD-TOC-01"),
            proc("","Check on sample of selected transactions covering  the  whole  period  that  all preventive controls are exercised on all transaction","LTD-TOC-02"),
            proc("","Check  that  proper  subsidiary  records have been maintained and entries are made  in  the  same  on  prompt  and consistent  basis  and  the  same  is reconciled with general ledger.","LTD-TOC-03"),
            proc("","Check on a sample of transactions that detective controls are appropriately been exercised and in case of any detection of error/ fraud, proper steps have been taken  to avoid recurrence of the same.","LTD-TOC-04")
          ],
          "Test of Details": [
            proc("","Obtain party wise movement  schedule of deposits and prepayments and trace the opening balances from the general ledger, subsidiary records, and last year working papers.  Check  casting  and  cross casting of the schedule.","LTD-TOD-01"),
            proc("","For  deposits  and  prepayments  made during the year check disbursements of funds  with  disbursement  voucher  and bank statement.","LTD-TOC-02"),
            proc("","For a sample of refund of deposits during the year Ensure  that  amount  and  date  of refund  was  in  accordance  with agreement.","LTD-TOC-03"),
            proc("","For a sample of refund of deposits during the year Check receipt of funds with receipt records and bank statement.","LTC-TOC-04"),
            proc("","Curcularize confirmations to selected parties. Match replies with the amounts outstanding against each party.","LTD-TOC-05"),
            proc("","Obtain age-analysis of long-term deposits and verify that deposits have been classified in correct categories.","LDT-TOC-06"),
            proc("","Obtain age-analysis of long-term deposits and verify that current maturity has been appropriately identified and separately disclosed.","LTD-TOC-07"),
            proc("","Check subsequent recovery of deposits and adjustment of prepayments etc.","LTD-TOC-08"),
            proc("","Ensure  that  none  of  the  deposits  or prepayments   are   impaired   or   the recoverable amount of same is not less than its carrying amount. If the carrying amount of a deposits or prepayments is more than its recoverable amount, then same should be reduced to recoverable amount  recognizing  the  reduction  as impairment loss.","LTD-TOC-09"),
            proc("","For  items stuck-up  for  considerable period of time, inquire about its status from the management. Compute provisions  if  required  and  ask  for management representations.","LTD-TOC-10"),
            proc("","Ensure that closing balances as per our working  paper  file  are  in  match  with general ledger.","LTD-TOC-11"),
            proc("","Determine  that  disclosures  have  been made in accordance with the requirements of fourth schedule to the Companies Act, 2017 and the applicable IASs","LTD-TOC-12")
          ]
        }
      },
      ...
      TD: {
        ...
        procedures: {
          ...
          "Test of Details": [
            ...
            proc("Debtors Movement","Obtain party-wise comparative schedule of debtors and circularize major and old balances for direct confirmation. Summarise response of circularization and discuss with client for differences and no response balances. Obtain reconciliation for disputed balances and send reminders to non confirmers.","TD-TOD-03"),
            ...
            proc("Debtors Movement","Obtain party-wise comparative schedule of debtors and consider results procedures b,c and d above and suggest and discuss provision for doubtful debts with client.","TD-TOD-05"),
            ...
            proc("Ledgers","Select 3 accounts from debtors and perform for the whole year and check opening and closing balances with ledgers.","TD-TOD-07"),
            proc("Ledgers","Select 3 accounts from debtors and perform for the whole year and check all debits and credits with source documents and ensure source documents relate to that debtor, approved and posted in correct period.","TD-TOD-08"),
    ...
    ADV: {
      ...
      procedures: {
        ...
        "Test of Details": [
          ...
          proc("Other Receivables", "All the items of receivables other than advances, deposits an prepayments and trade debts should be classified here.","ADV-TOD-06"),
     ...
     CASH: {
      ...
      procedures: {
        ...
        "Test of Controls": [
          ...
          proc("Bank Reconciliations","Obtain copies of reconciliations for all banks for one month and check items that are not cleared in subsequent month bank book, in quire about reason for not recording and check their appearance in next month’s bank reconciliation.","CASH-TOC-08"),
          proc("Bank Reconciliations","Obtain copies of reconciliations for all banks for one month and check long outstanding items in bank reconciliations should be discussed with client and appropriate action should be suggested for their reversal.","CASH-TOC-09"),
          proc("Bank Reconciliations","Obtain copies of reconciliations for all banks for one month and check for reversal items check their impact on revenue, expenses, liabilities and assets. Ensure that any of above account was inflated for window dressing.","CASH-TOC-10"),
          proc("Bank Reconciliations","For all banks agree book balances with bank statements either directly or through reconciliation. Check last month’s reconciling items and their subsequent clearance. If some reversals are required, incorporate them in year end. More than six months old cheques require revarsals.","CASH-TOC-11"),
          proc("Payment Vouchers","Select 15 vouchers each from cash and bank payments and check it’s authorization.","CASH-TOC-12"),
          ...
          proc("Payment Vouchers","Select 15 vouchers each from cash and bank payments and ensure that disbursement or checque issuance are made by person independent of  goods and services receiving or issuing function.","CASH-TOC-19"),
          ...
          proc("Receipt Vouchers","Select 30 receipts each from cash and bank and check it’s posting in correct account.","CASH-TOC-22"),
          proc("Receipt Vouchers","Select 30 receipts each from cash and bank and check it’s posting in correct period.","CASH-TOC-23"),
     ...
     CAL: {
      ...
      procedures: {
        "Analytical Procedures": [
          ...
          proc("General","Analyse ratio of total payables i.e creditors, accrued and other liabilities other than income and sales taxes, security deposits and accrued financial charges to total operating costs minus depreciation, taxes and financial costs. Compare this ratio with prior year and seek explanation for significant variances.","CAL-AP-03"),
        ...
        "Test of Controls": [
          ...
          proc("Schedules of Creditors and Other liabilities","Obtain schedules of Creditors and Other liabilities (other than accrued expenses). On selected parties check that the payments to creditors/accrued liabilities are made as per company's credit policy, if any and after obtaining appropriate approval to release payment. Deduction of tax at source made as per law.","CAL-TOC-03"),
          proc("General","Check that the opening balance of accrued expenses was made nil during the year.","PAY-TOC-04")
        ],
        "Test of Details": [
          ...
          proc("General","Circularise major and long outstanding balances and compare replies received with the amounts recorded in books. Seek explanation and obtain reconciliation in case of difference in amount replied and those recorded in the books.","CAL-TOD-08"),
      ...
      procedures: {
        ...
        "Test of Controls": [
          ...
          proc("Sales Transactions","Make a selection of sales transactions from sales ledger and check it’s posting in correct customer account.","REV-TOC-07"),
    ...
    OC: {
      ...
      procedures: {
        ...
        "Test of Details": [
          ...
          proc("Sample from each head of account","Select a sample from each head of account and Approval by appropriate authority.","OC-TOD-02"),
          proc("Sample from each head of account","Select a sample from each head of account and Expense is supported by evidence i.e bill, invoice.etc","OC-TOD-03"),
          proc("Sample from each head of account","Select a sample from each head of account and Payment is made through cash/check as per company policy.","OC-TOD-04"),
          proc("Sample from each head of account","Select a sample from each head of account and Expense is posted in correct account head.","OC-TOD-05"),
          proc("Sample from each head of account","Select a sample from each head of account and Expense is recorded in correct period.","OC-TOD-06"),
          proc("Sample from each head of account","Select a sample from each head of account and Income tax deduction is made as per law.","OC-TOD-07"),
    ...
    PAY: {
      ...
      procedures: {
        "Test of Details": [
          ...
          proc("Permanent employees","Select a sample of two months (one from each half year) from permanent employees and check over time payments, if any, are made as per rules of company.","PAY-TOD-11"),
          ...
          proc("Temporary workers","Select a sample of temporary workers and check over time payment is made as per rules.","PAY-TOD-17"),
          ...
          proc("New joiners","Select few joiners from all categories and trace entry into payroll of the month in which appointment made.","PAY-TOD-21"),
          ...
          proc("Leavers","Select few leavers during the year and check computation of final settlement and it’s payment. Check it is approved by authorized person.","PAY-TOD-26")
        ]
      }
    },
